...
public enum CallSettingsMerge {
    public static func merge(higher: ReeveCallSettings, lower: ReeveCallSettings) -> ReeveCallSettings {
        var out = higher
    ...
    static func mergeThinking(_ higher: ReeveThinkingSettings?, _ lower: ReeveThinkingSettings?) -> ReeveThinkingSettings? {
    ...
    static func mergeAnthropic(_ higher: ReeveAnthropicExtras?, _ lower: ReeveAnthropicExtras?) -> ReeveAnthropicExtras? {
        guard var out = higher else { return lower }
        guard let lower else { return out }
    ...
    static func mergeOpenAI(_ higher: ReeveOpenAIExtras?, _ lower: ReeveOpenAIExtras?) -> ReeveOpenAIExtras? {
        guard var out = higher else { return lower }
        guard let lower else { return out }
    ...
    static func mergeGoogle(_ higher: ReeveGoogleExtras?, _ lower: ReeveGoogleExtras?) -> ReeveGoogleExtras? {
        guard var out = higher else { return lower }
        guard let lower else { return out }
    ...
    static func mergeSafety(_ higher: ReeveSafetySettings?, _ lower: ReeveSafetySettings?) -> ReeveSafetySettings? {
        guard var out = higher else { return lower }
        guard let lower else { return out }
