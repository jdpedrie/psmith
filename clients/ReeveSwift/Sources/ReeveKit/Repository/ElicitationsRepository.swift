...
/// wire.
public enum ReeveElicitAction: String, Sendable, Hashable, Codable {
    case accept
    case decline
    case cancel
}
...
public final class ElicitationsRepository: Sendable {
    ...
    public func respond(
        ...
        guard let http = response as? HTTPURLResponse else {
            throw ReeveElicitationError.transport(URLError(.badServerResponse))
        }
        switch http.statusCode {
        case 200, 204:
            return
        case 401:
            throw ReeveElicitationError.unauthorized
        case 404:
            ...
            throw ReeveElicitationError.notFound
        default:
            let msg = String(data: data, encoding: .utf8) ?? "(no body)"
            throw ReeveElicitationError.serverError(status: http.statusCode, body: msg)
        }
    }
}

public enum ReeveElicitationError: Error, Sendable {
