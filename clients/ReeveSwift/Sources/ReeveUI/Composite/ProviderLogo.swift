...
import AppKit
typealias ReevePlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit
typealias ReevePlatformImage = UIImage
#endif
...
///
/// The slug names a SVG file under `ReeveUI/Resources/Logos/`. LobeHub
...
public struct ProviderLogo: View {
    ...
    private static let cache = NSCache<NSString, ReevePlatformImage>()

    private static func image(for slug: String?) -> ReevePlatformImage? {
