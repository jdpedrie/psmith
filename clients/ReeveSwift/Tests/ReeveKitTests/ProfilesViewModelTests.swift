...
struct ProfilesViewModelTests {
    ...
    func createErrorLeavesListUnchanged() async throws {
        ...
        let bad = ReeveProfilePatch(name: "")
        do {
    ...
    func updatePartialAndClear() async throws {
        ...
        // Partial: rename only.
        var patch = ReeveProfilePatch(name: "Mutated")
    ...
    func conciseNameWalksParents() async throws {
        ...
        let parent = try await vm.create(ReeveProfilePatch(name: "P", parentProfileID: grandparent.id))
        let child  = try await vm.create(ReeveProfilePatch(name: "C", parentProfileID: parent.id))
    ...
    func parentChainName() async throws {
        ...
        let child  = try await vm.create(ReeveProfilePatch(name: "Child", parentProfileID: parent.id))
