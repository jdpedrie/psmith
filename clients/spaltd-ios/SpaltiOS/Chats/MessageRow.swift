...
struct MessageRow: View {
    ...
    private var imageAttachments: [SpaltMessageAttachment] {
    ...
    /// thumbnailable.
    private var nonImageAttachments: [SpaltMessageAttachment] {
        message.attachments.filter { $0.kind != "image" }
    }
...
struct EditMessageSheet: View {
    ...
    @State private var editRoleDraft: SpaltMessageRole
    @Environment(\.dismiss) private var dismiss
    @FocusState private var editorFocused: Bool

    init(message: SpaltMessage, model: ConversationViewModel) {
