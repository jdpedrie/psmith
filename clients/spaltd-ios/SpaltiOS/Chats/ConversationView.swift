...
private let scrollLog = Logger(subsystem: "dev.jdpedrie.spalt", category: "ChatScroll")

/// iOS conversation surface. Constructs `ConversationViewModel` against
/// the live `spaltd`, then renders the status strip + message scroll.
...
private struct ChatHistoryArea: View {
    ...
    private var visibleMessages: [SpaltMessage] {
