...
struct ChatsRoot: View {
    ...
    @State private var deleteCandidate: SpaltConversation?
    @State private var renameCandidate: SpaltConversation?
    ...
    @State private var conversationPath: [SpaltConversation] = []
    ...
    var body: some View {
        NavigationStack(path: $conversationPath) {
            VStack(spacing: 0) {
                ...
                .navigationDestination(for: SpaltConversation.self) { conversation in
    ...
    private var sortMenu: some View {
        Menu {
            Picker("Sort", selection: Binding(
                ...
                Text("Recently Used").tag(SpaltConversationOrder.recentlyUsed)
                Text("Recently Created").tag(SpaltConversationOrder.recentlyCreated)
            }
        } label: {
    ...
    private var profilesSorted: [SpaltProfile] {
    ...
    @ViewBuilder
    private func conversationRowLink(_ c: SpaltConversation, hideProfile: Bool) -> some View {
        NavigationLink {
