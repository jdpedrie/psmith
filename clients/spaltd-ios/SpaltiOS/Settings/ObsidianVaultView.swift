    ...
    var body: some View {
        Form {
            Section {
                ...
                Text("Pick the folder you want Spalt to access — your entire Obsidian vault, or a subfolder of it (e.g. \"Vault/Spalt/\"). Spalt stores a security-scoped bookmark so it can read and write notes inside that folder without re-prompting. No Obsidian plugin or local-REST setup required.")
            }
