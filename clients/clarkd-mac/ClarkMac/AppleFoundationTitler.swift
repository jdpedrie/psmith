...
struct AppleFoundationTitler: LocalTitler {
    ...
    /// Reading `availability` is cheap and reflects the live state of
    /// Apple Intelligence (enabled/disabled, region eligibility, model
    /// download status). Returns false on SDKs without `FoundationModels`.
