...
struct CallSettingsFormSnapshots {
    ...
    private struct Wrapper: View {
        @State var settings: ClarkCallSettings
        let inheritedSettings: ClarkCallSettings?
        let driverType: String
        let modelCapabilities: ClarkModelCapabilities?

        init(
            settings: ClarkCallSettings = ClarkCallSettings(),
            inheritedSettings: ClarkCallSettings? = nil,
            driverType: String,
            modelCapabilities: ClarkModelCapabilities? = SnapshotFixtures.capabilitiesAllOn()
        ) {
