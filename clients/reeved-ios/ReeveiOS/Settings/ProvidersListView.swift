...
struct ProvidersListView: View {
    ...
    @State private var deleteCandidate: ReeveUserModelProvider?
    @State private var addingTemplate: ReeveProviderTemplate?
    ...
    private var availableTemplates: [ReeveProviderTemplate] {
        // ReeveUserModelProvider doesn't store catalogProviderID
    ...
    private func catalogKey(for provider: ReeveUserModelProvider) -> String {
    ...
    @ViewBuilder
    private func configuredRow(_ provider: ReeveUserModelProvider) -> some View {
        HStack(spacing: 10) {
    ...
    @ViewBuilder
    private func availableRow(_ template: ReeveProviderTemplate) -> some View {
        HStack(spacing: 10) {
    ...
    private func logoSlug(for provider: ReeveUserModelProvider) -> String? {
...
private struct ProviderDetailView: View {
    ...
    @ViewBuilder
    private func modelRow(_ m: ReeveUserModel) -> some View {
...
private struct ModelDefaultSettingsSheet: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .onAppear {
                if !seeded {
                    draft = model.defaultSettings ?? ReeveCallSettings()
                    seeded = true
                }
            }
        }
...
private struct DiscoverModelsScreen: View {
    ...
    @MainActor
    private func enableOne(_ m: ReeveDiscoveredModel) async {
