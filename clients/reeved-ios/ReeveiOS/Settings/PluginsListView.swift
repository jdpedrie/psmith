...
struct PluginsListView: View {
        ...
        Group {
            if !loaded {
                ...
                EmptyStateView(
                    ...
                    description: "The server's binary was built without any plugins registered. Check your reeved build."
                )
            } else {
                List {
    ...
    @ViewBuilder
    private func pluginRow(_ plugin: ReevePluginType) -> some View {
        HStack(spacing: 10) {
