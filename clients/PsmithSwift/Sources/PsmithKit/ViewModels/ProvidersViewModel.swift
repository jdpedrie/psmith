...
public enum ProviderTestStatus: Sendable, Equatable {
    case idle
    case testing
    case success(PsmithProviderTestResult)
    case failure(String)
}
...
public enum ModelTestStatus: Sendable, Equatable {
    case idle
    case testing
    case success(PsmithModelTestResult)
    case failure(String)
}
...
public final class ProvidersViewModel {
    ...
    public var providers: [PsmithUserModelProvider] = []
    public var selectedID: String?
    public var enabledModels: [PsmithUserModel] = []
    ...
    /// flow to fire it.
    public var templates: [PsmithProviderTemplate] = []
    ...
    public var pendingAddPreset: PsmithProviderTemplate?
    ...
    public var unconfiguredTemplates: [PsmithProviderTemplate] {
    ...
    public func startAddingWithPreset(_ template: PsmithProviderTemplate) {
    ...
    public func toggleModelFavorite(modelID: String) async {
        ...
        enabledModels[idx] = PsmithUserModel(
    ...
    public func createProvider(type: String, label: String, config: Data) async throws -> PsmithUserModelProvider {
    ...
    public func updateProviderDefaultSettings(providerID: String, settings: PsmithCallSettings) async throws {
    ...
    public func updateModelDefaultSettings(providerID: String, modelID: String, settings: PsmithCallSettings) async throws {
    ...
    public func testProvider(_ providerID: String) async {
        ...
        do {
            ...
            providerTestStatus[providerID] = .failure(PsmithError.display(error))
        }
    }
    ...
    public func testModel(providerID: String, modelID: String) async {
        ...
        do {
            ...
            modelTestStatus[key] = .failure(PsmithError.display(error))
        }
    }
}
