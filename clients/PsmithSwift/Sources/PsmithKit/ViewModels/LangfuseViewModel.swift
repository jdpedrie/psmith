...
///
/// Per Psmith's Swift conventions, this ViewModel lives in the
/// shared PsmithKit package so iOS can reuse it. Views are
...
public final class LangfuseViewModel {
    ...
    /// that window.
    public private(set) var saved: PsmithLangfuseConfig?
    ...
    public private(set) var testResult: PsmithLangfuseTestResult?
    ...
    public func test() async {
        ...
        do {
            ...
            testResult = PsmithLangfuseTestResult(
                ok: false,
