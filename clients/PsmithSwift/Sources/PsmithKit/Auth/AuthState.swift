...
public final class AuthState {
    ...
    public private(set) var currentUser: PsmithUser?

    public var isAuthenticated: Bool { phase == .signedIn }

    public init(phase: AuthPhase = .resolving, currentUser: PsmithUser? = nil) {
        self.phase = phase
    ...
    public convenience init(isAuthenticated: Bool, currentUser: PsmithUser? = nil) {
        self.init(
    ...
    public func setAuthenticated(_ user: PsmithUser) {
...
/// Plain Swift mirror of psmith.v1.User. Decoupled from generated types so
/// views don't import SwiftProtobuf.
public struct PsmithUser: Sendable, Hashable, Identifiable, Codable {
