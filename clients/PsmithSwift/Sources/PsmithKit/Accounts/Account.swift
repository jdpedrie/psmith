...
/// One psmithd login the app remembers across launches. Plural by
/// design — Psmith supports having multiple accounts signed in
...
public struct Account: Sendable, Hashable, Codable, Identifiable {
    public let id: UUID
    /// psmithd base URL — e.g. `https://psmith.example.com:8080`.
