...
struct ProfilesViewModelTests {
    ...
    func createErrorLeavesListUnchanged() async throws {
        ...
        let bad = PsmithProfilePatch(name: "")
        do {
    ...
    func updatePartialAndClear() async throws {
        ...
        // Partial: rename only.
        var patch = PsmithProfilePatch(name: "Mutated")
    ...
    func conciseNameWalksParents() async throws {
        ...
        let parent = try await vm.create(PsmithProfilePatch(name: "P", parentProfileID: grandparent.id))
        let child  = try await vm.create(PsmithProfilePatch(name: "C", parentProfileID: parent.id))
    ...
    func parentChainName() async throws {
        ...
        let child  = try await vm.create(PsmithProfilePatch(name: "Child", parentProfileID: parent.id))
