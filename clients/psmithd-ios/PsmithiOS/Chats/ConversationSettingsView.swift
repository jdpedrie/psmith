...
struct ConversationSettingsView: View {
    ...
    private var addablePluginTypes: [PsmithPluginType] {
        let active = Set(model.resolvedPluginPipeline.map { $0.pluginName })
    ...
    @ViewBuilder
    private func pluginRow(for entry: PsmithResolvedPipelineEntry) -> some View {
    ...
    @ViewBuilder
    private func sourceBadge(for source: PsmithResolvedPipelineSource) -> some View {
    ...
    private func registeredType(forName name: String?) -> PsmithPluginType? {
    ...
    private var effectiveModelCapabilities: PsmithModelCapabilities? {
...
private struct PluginEditScreen: View {
    ...
    let pluginType: PsmithPluginType?
