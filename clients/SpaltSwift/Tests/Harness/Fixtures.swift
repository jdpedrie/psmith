...
public enum Fixtures {
    ...
    public static func minimalProfilePatch(name: String = "Test Profile") -> SpaltProfilePatch {
        SpaltProfilePatch(name: name)
    }

    /// Full-fat patch covering every optional field — used by tests that
    /// verify create() round-trips the entire shape.
    public static func fullProfilePatch(name: String = "Full Profile") -> SpaltProfilePatch {
        SpaltProfilePatch(
            name: name,
    ...
    public static func unknownPlugin(ordinal: Int32 = 0) -> SpaltProfilePlugin {
        SpaltProfilePlugin(
    ...
    public static func seedFakeProvider(
        client: SpaltClient,
        label: String = "Fake"
    ) async throws -> (provider: SpaltUserModelProvider, fake: FakeProvider) {
    ...
    ) async throws -> (fake: FakeProvider, provider: SpaltUserModelProvider, model: SpaltUserModel, profile: SpaltProfile) {
