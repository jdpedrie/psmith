...
struct ProfilesViewModelTests {
    ...
    func createErrorLeavesListUnchanged() async throws {
        ...
        let bad = SpaltProfilePatch(name: "")
        do {
    ...
    func updatePartialAndClear() async throws {
        ...
        // Partial: rename only.
        var patch = SpaltProfilePatch(name: "Mutated")
    ...
    func conciseNameWalksParents() async throws {
        ...
        let parent = try await vm.create(SpaltProfilePatch(name: "P", parentProfileID: grandparent.id))
        let child  = try await vm.create(SpaltProfilePatch(name: "C", parentProfileID: parent.id))
    ...
    func parentChainName() async throws {
        ...
        let child  = try await vm.create(SpaltProfilePatch(name: "Child", parentProfileID: parent.id))
