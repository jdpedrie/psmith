...
/// One spaltd login the app remembers across launches. Plural by
/// design — Spalt supports having multiple accounts signed in
...
public struct Account: Sendable, Hashable, Codable, Identifiable {
    public let id: UUID
    /// spaltd base URL — e.g. `https://spalt.example.com:8080`.
