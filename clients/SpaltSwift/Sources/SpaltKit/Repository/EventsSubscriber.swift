...
/// intervention.
///
/// Not MainActor — SpaltClient's init runs in a non-isolated context
...
public final class EventsSubscriber: @unchecked Sendable {
    private let client: Spalt_V1_EventsServiceClientInterface
    ...
    public init(client: Spalt_V1_EventsServiceClientInterface) {
        self.client = client
    }
    ...
    private func subscribe() async throws {
        ...
        defer { stream.cancel() }
        try stream.send(Spalt_V1_SubscribeAccountEventsRequest())
    ...
    private func dispatch(_ event: Spalt_V1_AccountEvent) {
