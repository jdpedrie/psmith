...
public enum ProviderTestStatus: Sendable, Equatable {
    case idle
    case testing
    case success(SpaltProviderTestResult)
    case failure(String)
}
...
public enum ModelTestStatus: Sendable, Equatable {
    case idle
    case testing
    case success(SpaltModelTestResult)
    case failure(String)
}
...
public final class ProvidersViewModel {
    ...
    public var providers: [SpaltUserModelProvider] = []
    public var selectedID: String?
    public var enabledModels: [SpaltUserModel] = []
    ...
    /// flow to fire it.
    public var templates: [SpaltProviderTemplate] = []
    ...
    public var pendingAddPreset: SpaltProviderTemplate?
    ...
    public var unconfiguredTemplates: [SpaltProviderTemplate] {
    ...
    public func startAddingWithPreset(_ template: SpaltProviderTemplate) {
    ...
    public func toggleModelFavorite(modelID: String) async {
        ...
        enabledModels[idx] = SpaltUserModel(
    ...
    public func createProvider(type: String, label: String, config: Data) async throws -> SpaltUserModelProvider {
    ...
    public func updateProviderDefaultSettings(providerID: String, settings: SpaltCallSettings) async throws {
    ...
    public func updateModelDefaultSettings(providerID: String, modelID: String, settings: SpaltCallSettings) async throws {
    ...
    public func testProvider(_ providerID: String) async {
        ...
        do {
            ...
            providerTestStatus[providerID] = .failure(SpaltError.display(error))
        }
    }
    ...
    public func testModel(providerID: String, modelID: String) async {
        ...
        do {
            ...
            modelTestStatus[key] = .failure(SpaltError.display(error))
        }
    }
}
