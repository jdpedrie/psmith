...
///
/// Per Spalt's Swift conventions, this ViewModel lives in the
/// shared SpaltKit package so iOS can reuse it. Views are
...
public final class LangfuseViewModel {
    ...
    /// that window.
    public private(set) var saved: SpaltLangfuseConfig?
    ...
    public private(set) var testResult: SpaltLangfuseTestResult?
    ...
    public func test() async {
        ...
        do {
            ...
            testResult = SpaltLangfuseTestResult(
                ok: false,
