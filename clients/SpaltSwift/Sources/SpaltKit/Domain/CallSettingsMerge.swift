...
public enum CallSettingsMerge {
    public static func merge(higher: SpaltCallSettings, lower: SpaltCallSettings) -> SpaltCallSettings {
        var out = higher
    ...
    static func mergeThinking(_ higher: SpaltThinkingSettings?, _ lower: SpaltThinkingSettings?) -> SpaltThinkingSettings? {
    ...
    static func mergeAnthropic(_ higher: SpaltAnthropicExtras?, _ lower: SpaltAnthropicExtras?) -> SpaltAnthropicExtras? {
        guard var out = higher else { return lower }
        guard let lower else { return out }
    ...
    static func mergeOpenAI(_ higher: SpaltOpenAIExtras?, _ lower: SpaltOpenAIExtras?) -> SpaltOpenAIExtras? {
        guard var out = higher else { return lower }
        guard let lower else { return out }
    ...
    static func mergeGoogle(_ higher: SpaltGoogleExtras?, _ lower: SpaltGoogleExtras?) -> SpaltGoogleExtras? {
        guard var out = higher else { return lower }
        guard let lower else { return out }
    ...
    static func mergeSafety(_ higher: SpaltSafetySettings?, _ lower: SpaltSafetySettings?) -> SpaltSafetySettings? {
        guard var out = higher else { return lower }
        guard let lower else { return out }
