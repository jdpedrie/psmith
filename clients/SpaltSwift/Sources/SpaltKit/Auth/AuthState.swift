...
public final class AuthState {
    ...
    public private(set) var currentUser: SpaltUser?

    public var isAuthenticated: Bool { phase == .signedIn }

    public init(phase: AuthPhase = .resolving, currentUser: SpaltUser? = nil) {
        self.phase = phase
    ...
    public convenience init(isAuthenticated: Bool, currentUser: SpaltUser? = nil) {
        self.init(
    ...
    public func setAuthenticated(_ user: SpaltUser) {
...
/// Plain Swift mirror of spalt.v1.User. Decoupled from generated types so
/// views don't import SwiftProtobuf.
public struct SpaltUser: Sendable, Hashable, Identifiable, Codable {
