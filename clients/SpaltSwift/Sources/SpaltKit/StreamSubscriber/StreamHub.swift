...
public final class StreamHub {
    ...
    private var terminalHandlers: [String /* conversationID */: (SpaltStreamRun) async -> Void] = [:]
    ...
    private static let unseenStorageKey = "spalt.streamHub.unseenConversationIDs.v1"
    ...
    public func attach(
        ...
        onTerminal: @escaping (SpaltStreamRun) async -> Void
    ) {
    ...
    public func adopt(_ run: SpaltStreamRun) {
    ...
    private func applyChunk(_ c: SpaltChunk, runID: String, conversationID: String) {
    ...
    private func handleTerminal(run: SpaltStreamRun, conversationID: String) async {
