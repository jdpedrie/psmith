...
import AppKit
typealias SpaltPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit
typealias SpaltPlatformImage = UIImage
#endif
...
///
/// The slug names a SVG file under `SpaltUI/Resources/Logos/`. LobeHub
...
public struct ProviderLogo: View {
    ...
    private static let cache = NSCache<NSString, SpaltPlatformImage>()

    private static func image(for slug: String?) -> SpaltPlatformImage? {
