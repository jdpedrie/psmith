...
public struct StreamingRow: View {
    ...
    let streamingComponents: [SpaltStreamingComponentTag]
...
/// outside SpaltUI should drive this through StreamingRow.
func parseStreamingSegments(_ text: String, components: [SpaltStreamingComponentTag]) -> [StreamingSegment] {
    ...
    while i < text.endIndex {
        ...
        segments.append(.fragment(
            SpaltUIFragment(component: component, props: bodyData, key: "")
        ))
        i = closeRange.upperBound
    }
    flushPending()
