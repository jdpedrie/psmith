...
public struct ModelPickerList: View {
    ...
    let requiredCapabilities: SpaltModelCapabilities?
    let onSelect: (_ providerID: String, _ modelID: String) -> Void

    @Environment(\.theme) private var theme

    public init(
        models: [SpaltUserModel],
        ...
        requiredCapabilities: SpaltModelCapabilities? = nil,
    ...
    private func missingCapabilities(for model: SpaltUserModel) -> [String] {
