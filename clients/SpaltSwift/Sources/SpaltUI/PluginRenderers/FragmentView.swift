...
/// Top-level dispatcher for a message's `[SpaltUIFragment]` list.
...
public struct FragmentView: View {
    ...
    @ViewBuilder
    private func bodyFor(_ fragment: SpaltUIFragment) -> some View {
