...
struct ConversationBody: View {
    ...
    var body: some View {
        ...
        // window's solid backgroundColor (set in ReeveMacApp); the AppKit
    ...
    private func contextLabel(_ ctx: ReeveContext) -> String {
    ...
    private var groupedModels: [(providerID: String, label: String, models: [ReeveUserModel])] {
...
private struct MessageRow: View {
    ...
    private func thinkingDurationSeconds(for message: ReeveMessage) -> Double? {
...
private struct MessageUsagePopover: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            if let u = message.usage {
                ...
                // (Gemini's automatic) from explicit ones (Reeve
    ...
    private func cacheSavings(message: ReeveMessage, cacheReadTokens: Int32) -> Double? {
