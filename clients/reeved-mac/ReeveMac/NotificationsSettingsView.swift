    ...
    private var generationFinishedPane: some View {
        ...
        VStack(alignment: .leading, spacing: 14) {
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("Posts a macOS notification when an assistant turn completes while Reeve is in the background. Suppressed when Reeve is the active app — you're already looking at the result. Permission is requested the first time a notification would fire. Stored locally on this Mac; not synced.")
                    .font(.callout)
