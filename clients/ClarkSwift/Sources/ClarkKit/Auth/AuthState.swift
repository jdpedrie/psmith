...
public final class AuthState {
    ...
    public private(set) var currentUser: ClarkUser?

    public init(isAuthenticated: Bool = false, currentUser: ClarkUser? = nil) {
        self.isAuthenticated = isAuthenticated
        self.currentUser = currentUser
    }

    public func setAuthenticated(_ user: ClarkUser) {
...
public struct ClarkUser: Sendable, Hashable, Identifiable {
