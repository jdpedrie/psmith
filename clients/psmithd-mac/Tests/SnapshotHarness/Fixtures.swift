...
/// Pre-built PsmithKit domain models for snapshot tests. Every value is
...
public enum SnapshotFixtures {
    ...
    public static func user(
        ...
        PsmithUser(id: id, username: username, displayName: displayName, isAdmin: isAdmin)
    }
    ...
    public static func userModel(
        ...
        favorite: Bool = true,
        capabilities: PsmithModelCapabilities? = PsmithModelCapabilities(
    ...
    /// Note: `PsmithDiscoveredModel` doesn't expose a public memberwise
    ...
    /// fixture, or extend PsmithKit when that test ships.
    ...
    public static func conversations(profileID: String = "profile-default") -> [PsmithConversation] {
        [
    ...
    public static func contextChain(conversationID: String = "conv-1") -> [PsmithContext] {
        let root = context(
            id: "context-1",
            conversationID: conversationID,
    ...
    public static func assistantMessage(
        ...
        providerID: String? = "provider-anthropic",
        modelID: String? = "claude-opus-4-7",
        usage: PsmithMessageUsage? = SnapshotFixtures.standardUsage(),
    ...
    public static func sampleToolCalls() -> [PsmithToolCall] {
    ...
    public static func standardUsage() -> PsmithMessageUsage {
        PsmithMessageUsage(
            inputTokens: 1_280,
            outputTokens: 462,
            cacheReadTokens: 980,
    ...
    /// without scrolling.
    public static func sampleMessages() -> [PsmithMessage] {
        [
            systemMessage(),
            userMessage(),
            assistantMessage(),
    ...
    public static func pluginType(
        ...
        configFields: [PsmithConfigField] = SnapshotFixtures.letteredChoicesConfigFields()
    ) -> PsmithPluginType {
        PsmithPluginType(
            name: name,
            description: description,
    ...
    public static func letteredChoicesConfigFields() -> [PsmithConfigField] {
        [
            numberConfigField(
                name: "keep_last_n",
                display: "Keep last N",
    ...
    public static func selectShortConfigField(
        ...
        PsmithConfigField(
            ...
            defaultJSON: defaultJSON,
            options: [
                PsmithConfigOption(value: "compact", label: "Compact"),
                PsmithConfigOption(value: "verbose", label: "Verbose"),
                PsmithConfigOption(value: "academic", label: "Academic"),
            ]
        )
    }
    ...
    public static func selectLongConfigField(
        ...
        PsmithConfigField(
            ...
            defaultJSON: defaultJSON,
            options: [
                PsmithConfigOption(value: "neutral",   label: "Neutral"),
                PsmithConfigOption(value: "playful",   label: "Playful"),
                PsmithConfigOption(value: "formal",    label: "Formal"),
                PsmithConfigOption(value: "academic",  label: "Academic"),
                PsmithConfigOption(value: "concise",   label: "Concise"),
                PsmithConfigOption(value: "elaborate", label: "Elaborate"),
            ]
        )
    }
    ...
    public static func capabilitiesAllOn() -> PsmithModelCapabilities {
    ...
    public static func capabilitiesNoThinking() -> PsmithModelCapabilities {
        PsmithModelCapabilities(
    ...
    public static func commonInheritedCallSettings() -> PsmithCallSettings {
        PsmithCallSettings(
            temperature: 0.7,
            topP: 0.95,
            ...
            stopSequences: ["</done>"],
            topK: 40,
            thinking: PsmithThinkingSettings(enabled: true, budgetTokens: 8_192)
        )
    }

    /// Explicit Anthropic-driver extras, every field set so the section
    /// renders fully populated when used as the active settings.
    public static func anthropicExtrasCallSettings() -> PsmithCallSettings {
        var s = PsmithCallSettings()
        s.anthropic = PsmithAnthropicExtras(cacheEnabled: true, cacheTTL: .oneHour)
        s.thinking  = PsmithThinkingSettings(enabled: true, budgetTokens: 12_000)
        return s
    }
    ...
    public static func openaiExtrasCallSettings() -> PsmithCallSettings {
        var s = PsmithCallSettings()
        s.openai = PsmithOpenAIExtras(
            seed: 42,
    ...
    public static func googleExtrasCallSettings() -> PsmithCallSettings {
        var s = PsmithCallSettings()
        s.google = PsmithGoogleExtras(
            safetySettings: PsmithSafetySettings(
    ...
    public static func profileChain() -> [PsmithProfile] {
        let root = profile(
            id: "profile-root",
    ...
    /// Anthropic default.
    public static func providers() -> [PsmithUserModelProvider] {
        [
    ...
    public static func enabledModels() -> [PsmithUserModel] {
        [
            PsmithUserModel(
                providerID: "provider-anthropic",
                modelID: "claude-opus-4-7",
    ...
    public static func providerTemplates() -> [PsmithProviderTemplate] {
        [
            PsmithProviderTemplate(
    ...
    public static func discoveredModels() -> [PsmithDiscoveredModel] {
        [
            PsmithDiscoveredModel(
                modelID: "claude-opus-4-7",
                displayName: "Claude Opus 4.7",
                contextWindow: 200_000,
                pricing: PsmithModelPricing(inputPerMillion: 15.0, outputPerMillion: 75.0, cacheReadPerMillion: 1.5, cacheWritePerMillion: 18.75),
            ...
            PsmithDiscoveredModel(
                ...
                contextWindow: 200_000,
                pricing: PsmithModelPricing(inputPerMillion: 3.0, outputPerMillion: 15.0, cacheReadPerMillion: 0.30, cacheWritePerMillion: 3.75),
                capabilities: PsmithModelCapabilities(streaming: true, thinking: true, toolUse: true, vision: true, promptCaching: true),
            ...
            PsmithDiscoveredModel(
                ...
                displayName: "Claude Haiku 4.7",
                contextWindow: 200_000,
                pricing: PsmithModelPricing(inputPerMillion: 1.0, outputPerMillion: 5.0, cacheReadPerMillion: 0.10, cacheWritePerMillion: 1.25),
                capabilities: PsmithModelCapabilities(streaming: true, thinking: false, toolUse: true, vision: true, promptCaching: true),
                alreadyEnabled: true
            ),
            PsmithDiscoveredModel(
            ...
            PsmithDiscoveredModel(
                ...
                contextWindow: 200_000,
                pricing: PsmithModelPricing(inputPerMillion: 0.25, outputPerMillion: 1.25, cacheReadPerMillion: nil, cacheWritePerMillion: nil),
                capabilities: PsmithModelCapabilities(streaming: true, thinking: false, toolUse: true, vision: true, promptCaching: false),
                alreadyEnabled: true
            ),
        ]
    }

    /// One PsmithProfilePlugin attached to a profile. JSON config encodes
    ...
    public static func attachedPlugin(
        ...
        return PsmithProfilePlugin(pluginName: pluginName, ordinal: 0, config: data)
    }
}
