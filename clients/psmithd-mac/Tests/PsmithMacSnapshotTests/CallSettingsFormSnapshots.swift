...
struct CallSettingsFormSnapshots {
    ...
    private struct Wrapper: View {
        @State var settings: PsmithCallSettings
        let inheritedSettings: PsmithCallSettings?
        let driverType: String
        let modelCapabilities: PsmithModelCapabilities?

        init(
            settings: PsmithCallSettings = PsmithCallSettings(),
            inheritedSettings: PsmithCallSettings? = nil,
            driverType: String,
            modelCapabilities: PsmithModelCapabilities? = SnapshotFixtures.capabilitiesAllOn()
        ) {
