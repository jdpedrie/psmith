...
struct NewConversationView: View {
    ...
    @State private var conversationCallSettings = SpaltCallSettings()
    @State private var resolvedProfileForInherit: SpaltProfile?
    ...
    private var modelRowList: some View {
        ...
        let grouped: [(provider: String, models: [SpaltUserModel])] = Dictionary(grouping: nonFavorites) { $0.providerID }
    ...
    private var newConversationModelCapabilities: SpaltModelCapabilities? {
        let pid = overrideProviderID ?? resolvedProfileForInherit?.defaultSettings?.defaultProviderID
