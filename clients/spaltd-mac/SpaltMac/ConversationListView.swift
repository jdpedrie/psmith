...
struct ConversationListView: View {
    ...
    @State private var conversationToDelete: SpaltConversation?
    ...
    private func sortPopoverButton(_ title: String, target: SpaltConversationOrder) -> some View {
        @Bindable var convos = convos
...
/// Mac wrapper around SpaltUI's shared `ConversationRow`. Adds the
