...
/// Pre-built SpaltKit domain models for snapshot tests. Every value is
...
public enum SnapshotFixtures {
    ...
    public static func user(
        ...
        SpaltUser(id: id, username: username, displayName: displayName, isAdmin: isAdmin)
    }
    ...
    public static func profile(
        ...
        SpaltProfile(
            ...
            defaultSettings: SpaltProfileDefaults(
    ...
    public static func userModel(
        ...
        favorite: Bool = true,
        capabilities: SpaltModelCapabilities? = SpaltModelCapabilities(
    ...
    /// Note: `SpaltDiscoveredModel` doesn't expose a public memberwise
    ...
    /// fixture, or extend SpaltKit when that test ships.
    ...
    public static func conversations(profileID: String = "profile-default") -> [SpaltConversation] {
        [
    ...
    public static func contextChain(conversationID: String = "conv-1") -> [SpaltContext] {
        let root = context(
            id: "context-1",
            conversationID: conversationID,
    ...
    public static func assistantMessage(
        ...
        providerID: String? = "provider-anthropic",
        modelID: String? = "claude-opus-4-7",
        usage: SpaltMessageUsage? = SnapshotFixtures.standardUsage(),
    ...
    public static func sampleToolCalls() -> [SpaltToolCall] {
    ...
    public static func standardUsage() -> SpaltMessageUsage {
        SpaltMessageUsage(
            inputTokens: 1_280,
            outputTokens: 462,
            cacheReadTokens: 980,
    ...
    /// without scrolling.
    public static func sampleMessages() -> [SpaltMessage] {
        [
            systemMessage(),
            userMessage(),
            assistantMessage(),
    ...
    public static func pluginType(
        ...
        configFields: [SpaltConfigField] = SnapshotFixtures.letteredChoicesConfigFields()
    ) -> SpaltPluginType {
        SpaltPluginType(
            name: name,
            description: description,
            capabilities: SpaltPluginCapabilities(
                configurable: true,
                systemPrompter: true,
    ...
    public static func letteredChoicesConfigFields() -> [SpaltConfigField] {
        [
            numberConfigField(
                name: "keep_last_n",
                display: "Keep last N",
    ...
    public static func selectShortConfigField(
        ...
        SpaltConfigField(
            ...
            defaultJSON: defaultJSON,
            options: [
                SpaltConfigOption(value: "compact", label: "Compact"),
                SpaltConfigOption(value: "verbose", label: "Verbose"),
                SpaltConfigOption(value: "academic", label: "Academic"),
            ]
        )
    }
    ...
    public static func selectLongConfigField(
        ...
        SpaltConfigField(
            ...
            defaultJSON: defaultJSON,
            options: [
                SpaltConfigOption(value: "neutral",   label: "Neutral"),
                SpaltConfigOption(value: "playful",   label: "Playful"),
                SpaltConfigOption(value: "formal",    label: "Formal"),
                SpaltConfigOption(value: "academic",  label: "Academic"),
                SpaltConfigOption(value: "concise",   label: "Concise"),
                SpaltConfigOption(value: "elaborate", label: "Elaborate"),
            ]
        )
    }
    ...
    public static func capabilitiesAllOn() -> SpaltModelCapabilities {
        SpaltModelCapabilities(
            streaming: true, thinking: true, toolUse: true, vision: true, promptCaching: true
        )
    }
    ...
    public static func capabilitiesNoThinking() -> SpaltModelCapabilities {
        SpaltModelCapabilities(
    ...
    public static func commonInheritedCallSettings() -> SpaltCallSettings {
        SpaltCallSettings(
            temperature: 0.7,
            topP: 0.95,
            ...
            stopSequences: ["</done>"],
            topK: 40,
            thinking: SpaltThinkingSettings(enabled: true, budgetTokens: 8_192)
        )
    }

    /// Explicit Anthropic-driver extras, every field set so the section
    /// renders fully populated when used as the active settings.
    public static func anthropicExtrasCallSettings() -> SpaltCallSettings {
        var s = SpaltCallSettings()
        s.anthropic = SpaltAnthropicExtras(cacheEnabled: true, cacheTTL: .oneHour)
        s.thinking  = SpaltThinkingSettings(enabled: true, budgetTokens: 12_000)
        return s
    }
    ...
    public static func openaiExtrasCallSettings() -> SpaltCallSettings {
        var s = SpaltCallSettings()
        s.openai = SpaltOpenAIExtras(
            seed: 42,
    ...
    public static func googleExtrasCallSettings() -> SpaltCallSettings {
        var s = SpaltCallSettings()
        s.google = SpaltGoogleExtras(
            safetySettings: SpaltSafetySettings(
    ...
    public static func profileChain() -> [SpaltProfile] {
        let root = profile(
            id: "profile-root",
    ...
    /// Anthropic default.
    public static func providers() -> [SpaltUserModelProvider] {
        [
    ...
    public static func enabledModels() -> [SpaltUserModel] {
        [
            SpaltUserModel(
                providerID: "provider-anthropic",
                modelID: "claude-opus-4-7",
    ...
    public static func providerTemplates() -> [SpaltProviderTemplate] {
        [
            SpaltProviderTemplate(
    ...
    public static func discoveredModels() -> [SpaltDiscoveredModel] {
        [
            SpaltDiscoveredModel(
                modelID: "claude-opus-4-7",
                displayName: "Claude Opus 4.7",
                contextWindow: 200_000,
                pricing: SpaltModelPricing(inputPerMillion: 15.0, outputPerMillion: 75.0, cacheReadPerMillion: 1.5, cacheWritePerMillion: 18.75),
                capabilities: SpaltModelCapabilities(streaming: true, thinking: true, toolUse: true, vision: true, promptCaching: true),
                alreadyEnabled: true
            ),
            SpaltDiscoveredModel(
                ...
                contextWindow: 200_000,
                pricing: SpaltModelPricing(inputPerMillion: 3.0, outputPerMillion: 15.0, cacheReadPerMillion: 0.30, cacheWritePerMillion: 3.75),
                capabilities: SpaltModelCapabilities(streaming: true, thinking: true, toolUse: true, vision: true, promptCaching: true),
            ...
            SpaltDiscoveredModel(
                ...
                displayName: "Claude Haiku 4.7",
                contextWindow: 200_000,
                pricing: SpaltModelPricing(inputPerMillion: 1.0, outputPerMillion: 5.0, cacheReadPerMillion: 0.10, cacheWritePerMillion: 1.25),
                capabilities: SpaltModelCapabilities(streaming: true, thinking: false, toolUse: true, vision: true, promptCaching: true),
                alreadyEnabled: true
            ),
            SpaltDiscoveredModel(
            ...
            SpaltDiscoveredModel(
                ...
                contextWindow: 200_000,
                pricing: SpaltModelPricing(inputPerMillion: 0.25, outputPerMillion: 1.25, cacheReadPerMillion: nil, cacheWritePerMillion: nil),
                capabilities: SpaltModelCapabilities(streaming: true, thinking: false, toolUse: true, vision: true, promptCaching: false),
                alreadyEnabled: true
            ),
        ]
    }

    /// One SpaltProfilePlugin attached to a profile. JSON config encodes
    ...
    public static func attachedPlugin(
        ...
        return SpaltProfilePlugin(pluginName: pluginName, ordinal: 0, config: data)
    }
}
