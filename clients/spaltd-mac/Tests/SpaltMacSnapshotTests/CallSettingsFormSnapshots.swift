...
struct CallSettingsFormSnapshots {
    ...
    private struct Wrapper: View {
        @State var settings: SpaltCallSettings
        let inheritedSettings: SpaltCallSettings?
        let driverType: String
        let modelCapabilities: SpaltModelCapabilities?

        init(
            settings: SpaltCallSettings = SpaltCallSettings(),
            inheritedSettings: SpaltCallSettings? = nil,
            driverType: String,
            modelCapabilities: SpaltModelCapabilities? = SnapshotFixtures.capabilitiesAllOn()
        ) {
