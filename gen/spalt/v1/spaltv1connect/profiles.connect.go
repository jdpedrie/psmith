...
const (
	...
	ProfilesServiceName = "spalt.v1.ProfilesService"
)
...
const (
	...
	ProfilesServiceGetUserPluginSettingsProcedure = "/spalt.v1.ProfilesService/GetUserPluginSettings"
	...
	ProfilesServiceListUserPluginSettingsProcedure = "/spalt.v1.ProfilesService/ListUserPluginSettings"
	...
	ProfilesServiceUpsertUserPluginSettingsProcedure = "/spalt.v1.ProfilesService/UpsertUserPluginSettings"
)

// ProfilesServiceClient is a client for the spalt.v1.ProfilesService service.
...
// NewProfilesServiceClient constructs a client for the spalt.v1.ProfilesService service. By
...
func NewProfilesServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProfilesServiceClient {
	...
	profilesServiceMethods := v1.File_spalt_v1_profiles_proto.Services().ByName("ProfilesService").Methods()
...
// CreateProfile calls spalt.v1.ProfilesService.CreateProfile.
...
// ListProfiles calls spalt.v1.ProfilesService.ListProfiles.
...
// GetProfile calls spalt.v1.ProfilesService.GetProfile.
...
// UpdateProfile calls spalt.v1.ProfilesService.UpdateProfile.
...
// DeleteProfile calls spalt.v1.ProfilesService.DeleteProfile.
...
// ListPluginTypes calls spalt.v1.ProfilesService.ListPluginTypes.
...
// GetProfilePlugins calls spalt.v1.ProfilesService.GetProfilePlugins.
...
// SetProfilePlugins calls spalt.v1.ProfilesService.SetProfilePlugins.
...
// GetUserPluginSettings calls spalt.v1.ProfilesService.GetUserPluginSettings.
...
// ListUserPluginSettings calls spalt.v1.ProfilesService.ListUserPluginSettings.
...
// UpsertUserPluginSettings calls spalt.v1.ProfilesService.UpsertUserPluginSettings.
...
// ProfilesServiceHandler is an implementation of the spalt.v1.ProfilesService service.
...
func NewProfilesServiceHandler(svc ProfilesServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/spalt.v1.ProfilesService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedProfilesServiceHandler) CreateProfile(context.Context, *connect.Request[v1.CreateProfileRequest]) (*connect.Response[v1.CreateProfileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("spalt.v1.ProfilesService.CreateProfile is not implemented"))
}
...
func (UnimplementedProfilesServiceHandler) ListProfiles(context.Context, *connect.Request[v1.ListProfilesRequest]) (*connect.Response[v1.ListProfilesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("spalt.v1.ProfilesService.ListProfiles is not implemented"))
}
...
func (UnimplementedProfilesServiceHandler) GetProfile(context.Context, *connect.Request[v1.GetProfileRequest]) (*connect.Response[v1.GetProfileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("spalt.v1.ProfilesService.GetProfile is not implemented"))
}
...
func (UnimplementedProfilesServiceHandler) UpdateProfile(context.Context, *connect.Request[v1.UpdateProfileRequest]) (*connect.Response[v1.UpdateProfileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("spalt.v1.ProfilesService.UpdateProfile is not implemented"))
}
...
func (UnimplementedProfilesServiceHandler) DeleteProfile(context.Context, *connect.Request[v1.DeleteProfileRequest]) (*connect.Response[v1.DeleteProfileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("spalt.v1.ProfilesService.DeleteProfile is not implemented"))
}
...
func (UnimplementedProfilesServiceHandler) ListPluginTypes(context.Context, *connect.Request[v1.ListPluginTypesRequest]) (*connect.Response[v1.ListPluginTypesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("spalt.v1.ProfilesService.ListPluginTypes is not implemented"))
}
...
func (UnimplementedProfilesServiceHandler) GetProfilePlugins(context.Context, *connect.Request[v1.GetProfilePluginsRequest]) (*connect.Response[v1.GetProfilePluginsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("spalt.v1.ProfilesService.GetProfilePlugins is not implemented"))
}
...
func (UnimplementedProfilesServiceHandler) SetProfilePlugins(context.Context, *connect.Request[v1.SetProfilePluginsRequest]) (*connect.Response[v1.SetProfilePluginsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("spalt.v1.ProfilesService.SetProfilePlugins is not implemented"))
}
...
func (UnimplementedProfilesServiceHandler) GetUserPluginSettings(context.Context, *connect.Request[v1.GetUserPluginSettingsRequest]) (*connect.Response[v1.GetUserPluginSettingsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("spalt.v1.ProfilesService.GetUserPluginSettings is not implemented"))
}
...
func (UnimplementedProfilesServiceHandler) ListUserPluginSettings(context.Context, *connect.Request[v1.ListUserPluginSettingsRequest]) (*connect.Response[v1.ListUserPluginSettingsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("spalt.v1.ProfilesService.ListUserPluginSettings is not implemented"))
}
...
func (UnimplementedProfilesServiceHandler) UpsertUserPluginSettings(context.Context, *connect.Request[v1.UpsertUserPluginSettingsRequest]) (*connect.Response[v1.UpsertUserPluginSettingsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("spalt.v1.ProfilesService.UpsertUserPluginSettings is not implemented"))
}
