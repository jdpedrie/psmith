...
const file_clark_v1_auth_proto_rawDesc = "" +
	...
	"\x04user\x18\x03 \x01(\v2\x0e.clark.v1.UserR\x04user\"\x0f\n" +
	"\rLogoutRequest\"\x10\n" +
	"\x0eLogoutResponse\"\x0f\n" +
	"\rWhoAmIRequest\"4\n" +
	"\x0eWhoAmIResponse\x12\"\n" +
	"\x04user\x18\x01 \x01(\v2\x0e.clark.v1.UserR\x04user\"]\n" +
	...
	"\x04user\x18\x01 \x01(\v2\x0e.clark.v1.UserR\x04user\"\x12\n" +
	"\x10ListUsersRequest\"9\n" +
	"\x11ListUsersResponse\x12$\n" +
	"\x05users\x18\x01 \x03(\v2\x0e.clark.v1.UserR\x05users\" \n" +
	"\x0eGetUserRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"5\n" +
	"\x0fGetUserResponse\x12\"\n" +
	"\x04user\x18\x01 \x01(\v2\x0e.clark.v1.UserR\x04user\"\xac\x01\n" +
	...
	"\x0eChangePassword\x12\x1f.clark.v1.ChangePasswordRequest\x1a .clark.v1.ChangePasswordResponse\x12G\n" +
	"\n" +
	"CreateUser\x12\x1b.clark.v1.CreateUserRequest\x1a\x1c.clark.v1.CreateUserResponse\x12D\n" +
	"\tListUsers\x12\x1a.clark.v1.ListUsersRequest\x1a\x1b.clark.v1.ListUsersResponse\x12>\n" +
	"\aGetUser\x12\x18.clark.v1.GetUserRequest\x1a\x19.clark.v1.GetUserResponse\x12G\n" +
	"\n" +
...
var (
	...
	file_clark_v1_auth_proto_rawDescData []byte
)

func file_clark_v1_auth_proto_rawDescGZIP() []byte {
	file_clark_v1_auth_proto_rawDescOnce.Do(func() {
		file_clark_v1_auth_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_clark_v1_auth_proto_rawDesc), len(file_clark_v1_auth_proto_rawDesc)))
	})
...
func init() { file_clark_v1_auth_proto_init() }
func file_clark_v1_auth_proto_init() {
	if File_clark_v1_auth_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_clark_v1_auth_proto_goTypes,
		DependencyIndexes: file_clark_v1_auth_proto_depIdxs,
		MessageInfos:      file_clark_v1_auth_proto_msgTypes,
	}.Build()
	File_clark_v1_auth_proto = out.File
	file_clark_v1_auth_proto_goTypes = nil
	file_clark_v1_auth_proto_depIdxs = nil
}
