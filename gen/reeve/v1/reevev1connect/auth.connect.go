...
const (
	...
	AuthServiceName = "reeve.v1.AuthService"
)
...
// NewAuthServiceClient constructs a client for the reeve.v1.AuthService service. By default, it
...
func NewAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuthServiceClient {
	...
	authServiceMethods := v1.File_reeve_v1_auth_proto.Services().ByName("AuthService").Methods()
...
// Probe calls reeve.v1.AuthService.Probe.
...
// Login calls reeve.v1.AuthService.Login.
func (c *authServiceClient) Login(ctx context.Context, req *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return c.login.CallUnary(ctx, req)
}

// Logout calls reeve.v1.AuthService.Logout.
...
// WhoAmI calls reeve.v1.AuthService.WhoAmI.
...
// ChangePassword calls reeve.v1.AuthService.ChangePassword.
...
// CreateUser calls reeve.v1.AuthService.CreateUser.
...
// ListUsers calls reeve.v1.AuthService.ListUsers.
...
// GetUser calls reeve.v1.AuthService.GetUser.
...
// UpdateUser calls reeve.v1.AuthService.UpdateUser.
...
// DeleteUser calls reeve.v1.AuthService.DeleteUser.
...
// AdminResetPassword calls reeve.v1.AuthService.AdminResetPassword.
...
func NewAuthServiceHandler(svc AuthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/reeve.v1.AuthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthServiceHandler) Probe(context.Context, *connect.Request[v1.ProbeRequest]) (*connect.Response[v1.ProbeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reeve.v1.AuthService.Probe is not implemented"))
}

func (UnimplementedAuthServiceHandler) Login(context.Context, *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reeve.v1.AuthService.Login is not implemented"))
}

func (UnimplementedAuthServiceHandler) Logout(context.Context, *connect.Request[v1.LogoutRequest]) (*connect.Response[v1.LogoutResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reeve.v1.AuthService.Logout is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) WhoAmI(context.Context, *connect.Request[v1.WhoAmIRequest]) (*connect.Response[v1.WhoAmIResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reeve.v1.AuthService.WhoAmI is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) ChangePassword(context.Context, *connect.Request[v1.ChangePasswordRequest]) (*connect.Response[v1.ChangePasswordResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reeve.v1.AuthService.ChangePassword is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) CreateUser(context.Context, *connect.Request[v1.CreateUserRequest]) (*connect.Response[v1.CreateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reeve.v1.AuthService.CreateUser is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) ListUsers(context.Context, *connect.Request[v1.ListUsersRequest]) (*connect.Response[v1.ListUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reeve.v1.AuthService.ListUsers is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) GetUser(context.Context, *connect.Request[v1.GetUserRequest]) (*connect.Response[v1.GetUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reeve.v1.AuthService.GetUser is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) UpdateUser(context.Context, *connect.Request[v1.UpdateUserRequest]) (*connect.Response[v1.UpdateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reeve.v1.AuthService.UpdateUser is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) DeleteUser(context.Context, *connect.Request[v1.DeleteUserRequest]) (*connect.Response[v1.DeleteUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reeve.v1.AuthService.DeleteUser is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) AdminResetPassword(context.Context, *connect.Request[v1.AdminResetPasswordRequest]) (*connect.Response[v1.AdminResetPasswordResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("reeve.v1.AuthService.AdminResetPassword is not implemented"))
}
