...
func TestListProviderTypes_IncludesRegistered(t *testing.T) {
	...
	resp, err := svc.ListProviderTypes(context.Background(), connect.NewRequest(&clarkv1.ListProviderTypesRequest{}))
	if err != nil {
		t.Fatalf("ListProviderTypes: %v", err)
	}

	var found *clarkv1.ProviderType
...
func TestListProviderTemplates_PresetRegistry(t *testing.T) {
	...
	got := map[string]*clarkv1.ProviderTemplate{}
...
func TestListUserModelProviders_PerUser(t *testing.T) {
	...
	resp, err := svc.ListUserModelProviders(ctxAs(alice), connect.NewRequest(&clarkv1.ListUserModelProvidersRequest{}))
	if err != nil {
		t.Fatalf("List: %v", err)
	}
...
func TestGetUserModelProvider_OwnerCanRead(t *testing.T) {
	...
	resp, err := svc.GetUserModelProvider(ctxAs(user), connect.NewRequest(&clarkv1.GetUserModelProviderRequest{
		Id: prov.ID.String(),
	}))
	if err != nil {
		t.Fatalf("Get: %v", err)
...
func TestGetUserModelProvider_OtherUserNotFound(t *testing.T) {
	...
	_, err := svc.GetUserModelProvider(ctxAs(bob), connect.NewRequest(&clarkv1.GetUserModelProviderRequest{
		Id: prov.ID.String(),
	}))
...
func TestGetUserModelProvider_InvalidID(t *testing.T) {
	...
	svc, q, _, _ := newTestService(t)
	user := mustUser(t, q, "alice", false)
	_, err := svc.GetUserModelProvider(ctxAs(user), connect.NewRequest(&clarkv1.GetUserModelProviderRequest{
		Id: "not-a-uuid",
	}))
	assertCode(t, err, connect.CodeInvalidArgument)
}
...
func TestUpdateUserModelProvider_OtherUserNotFound(t *testing.T) {
	...
	newLabel := "x"
	_, err := svc.UpdateUserModelProvider(ctxAs(bob), connect.NewRequest(&clarkv1.UpdateUserModelProviderRequest{
		Id:    prov.ID.String(),
		Label: &newLabel,
	}))
	assertCode(t, err, connect.CodeNotFound)
...
func TestUpdateUserModelProvider_InvalidConfig(t *testing.T) {
	...
	_, err := svc.UpdateUserModelProvider(ctxAs(user), connect.NewRequest(&clarkv1.UpdateUserModelProviderRequest{
		Id:     prov.ID.String(),
		Config: []byte("not-json"),
	}))
	assertCode(t, err, connect.CodeInvalidArgument)
...
func TestDeleteUserModelProvider_Success(t *testing.T) {
	...
	if _, err := svc.DeleteUserModelProvider(ctxAs(user), connect.NewRequest(&clarkv1.DeleteUserModelProviderRequest{
		Id: prov.ID.String(),
	})); err != nil {
...
func TestDeleteUserModelProvider_OtherUserNotFound(t *testing.T) {
	...
	_, err := svc.DeleteUserModelProvider(ctxAs(bob), connect.NewRequest(&clarkv1.DeleteUserModelProviderRequest{
		Id: prov.ID.String(),
	}))
	assertCode(t, err, connect.CodeNotFound)
}
...
func TestDiscoverModels_FlagsAlreadyEnabled(t *testing.T) {
	...
	resp, err := svc.DiscoverModels(ctxAs(user), connect.NewRequest(&clarkv1.DiscoverModelsRequest{
...
func TestDiscoverModels_DriverError(t *testing.T) {
	...
	_, err := svc.DiscoverModels(ctxAs(user), connect.NewRequest(&clarkv1.DiscoverModelsRequest{
		UserModelProviderId: prov.ID.String(),
	}))
...
func TestDiscoverModels_OtherUserNotFound(t *testing.T) {
	...
	_, err := svc.DiscoverModels(ctxAs(bob), connect.NewRequest(&clarkv1.DiscoverModelsRequest{
		UserModelProviderId: prov.ID.String(),
	}))
	assertCode(t, err, connect.CodeNotFound)
}
...
func TestEnableModels_FromCatalog(t *testing.T) {
	...
	resp, err := svc.EnableModels(ctxAs(user), connect.NewRequest(&clarkv1.EnableModelsRequest{
		UserModelProviderId: prov.ID.String(),
	...
	if got.MetadataSource != clarkv1.MetadataSource_METADATA_SOURCE_CATALOG {
...
func TestEnableModels_NotDiscoverable(t *testing.T) {
	...
	_, err := svc.EnableModels(ctxAs(user), connect.NewRequest(&clarkv1.EnableModelsRequest{
		UserModelProviderId: prov.ID.String(),
...
func TestEnableModels_OtherUserNotFound(t *testing.T) {
	...
	_, err := svc.EnableModels(ctxAs(bob), connect.NewRequest(&clarkv1.EnableModelsRequest{
		UserModelProviderId: prov.ID.String(),
		ModelIds:            []string{"m1"},
	}))
	assertCode(t, err, connect.CodeNotFound)
...
func TestDisableModels_RemovesRow(t *testing.T) {
	...
	if _, err := svc.DisableModels(ctxAs(user), connect.NewRequest(&clarkv1.DisableModelsRequest{
		UserModelProviderId: prov.ID.String(),
		ModelIds:            []string{"m1"},
	})); err != nil {
...
func TestDisableModels_OtherUserNotFound(t *testing.T) {
	...
	_, err := svc.DisableModels(ctxAs(bob), connect.NewRequest(&clarkv1.DisableModelsRequest{
		UserModelProviderId: prov.ID.String(),
		ModelIds:            []string{"x"},
	}))
	assertCode(t, err, connect.CodeNotFound)
...
func TestListUserModels_PerInstance(t *testing.T) {
	...
	resp, err := svc.ListUserModels(ctxAs(user), connect.NewRequest(&clarkv1.ListUserModelsRequest{
...
func TestListUserModels_OtherUserNotFound(t *testing.T) {
	...
	_, err := svc.ListUserModels(ctxAs(bob), connect.NewRequest(&clarkv1.ListUserModelsRequest{
		UserModelProviderId: prov.ID.String(),
	}))
	assertCode(t, err, connect.CodeNotFound)
}
...
func TestListAllUserModels_AcrossProviders(t *testing.T) {
	...
	resp, err := svc.ListAllUserModels(ctxAs(user), connect.NewRequest(&clarkv1.ListAllUserModelsRequest{}))
	if err != nil {
...
func TestListAllUserModels_PerUser(t *testing.T) {
	...
	resp, err := svc.ListAllUserModels(ctxAs(alice), connect.NewRequest(&clarkv1.ListAllUserModelsRequest{}))
	if err != nil {
		t.Fatalf("ListAll: %v", err)
	}
...
func TestRefreshModelCatalog_Admin(t *testing.T) {
	...
	resp, err := svc.RefreshModelCatalog(ctxAs(admin), connect.NewRequest(&clarkv1.RefreshModelCatalogRequest{}))
	if err != nil {
...
func TestRefreshModelCatalog_NonAdminDenied(t *testing.T) {
	...
	_, err := svc.RefreshModelCatalog(ctxAs(regular), connect.NewRequest(&clarkv1.RefreshModelCatalogRequest{}))
...
func TestGetCatalogStatus_Authenticated(t *testing.T) {
	...
	resp, err := svc.GetCatalogStatus(ctxAs(user), connect.NewRequest(&clarkv1.GetCatalogStatusRequest{}))
	if err != nil {
...
func TestEnableModels_FromCatalog_RichMetadata_RoundTrip(t *testing.T) {
	...
	enableResp, err := svc.EnableModels(ctxAs(user), connect.NewRequest(&clarkv1.EnableModelsRequest{
		UserModelProviderId: prov.ID.String(),
...
func TestDiscoverModels_PassesThroughRichMetadata(t *testing.T) {
	...
	if d.MetadataSource != clarkv1.MetadataSource_METADATA_SOURCE_CATALOG {
