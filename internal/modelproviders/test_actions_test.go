...
func TestTestUserModelProvider_Success(t *testing.T) {
	...
	resp, err := svc.TestUserModelProvider(ctxAs(user), connect.NewRequest(&spaltv1.TestUserModelProviderRequest{
...
func TestTestUserModelProvider_OtherUserNotFound(t *testing.T) {
	...
	_, err := svc.TestUserModelProvider(ctxAs(bob), connect.NewRequest(&spaltv1.TestUserModelProviderRequest{
		UserModelProviderId: prov.ID.String(),
	}))
...
func TestTestUserModelProvider_UnknownDriverType_FailedPrecondition(t *testing.T) {
	...
	_, err := svc.TestUserModelProvider(ctxAs(user), connect.NewRequest(&spaltv1.TestUserModelProviderRequest{
		UserModelProviderId: prov.ID.String(),
	}))
...
func TestTestUserModel_HappyPath(t *testing.T) {
	...
	resp, err := svc.TestUserModel(ctxAs(user), connect.NewRequest(&spaltv1.TestUserModelRequest{
		UserModelProviderId: prov.ID.String(),
...
func TestTestUserModel_EmptyModelID_InvalidArgument(t *testing.T) {
	...
	_, err := svc.TestUserModel(ctxAs(user), connect.NewRequest(&spaltv1.TestUserModelRequest{
		UserModelProviderId: prov.ID.String(),
		ModelId:             "",
	}))
...
func TestTestUserModel_OtherUserNotFound(t *testing.T) {
	...
	_, err := svc.TestUserModel(ctxAs(bob), connect.NewRequest(&spaltv1.TestUserModelRequest{
		UserModelProviderId: prov.ID.String(),
		ModelId:             "x",
	}))
	assertCode(t, err, connect.CodeNotFound)
