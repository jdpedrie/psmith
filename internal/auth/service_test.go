...
func TestService_Login_Success(t *testing.T) {
	...
	resp, err := svc.Login(context.Background(), connect.NewRequest(&clarkv1.LoginRequest{
...
func TestService_Login_WrongPassword(t *testing.T) {
	...
	_, err := svc.Login(context.Background(), connect.NewRequest(&clarkv1.LoginRequest{
...
func TestService_Logout_DeletesSession(t *testing.T) {
	...
	loginResp, err := svc.Login(context.Background(), connect.NewRequest(&clarkv1.LoginRequest{
	...
	req := connect.NewRequest(&clarkv1.LogoutRequest{})
...
func TestService_Logout_MissingHeader(t *testing.T) {
	t.Parallel()
	svc, _ := newTestSvc(t)
	_, err := svc.Logout(context.Background(), connect.NewRequest(&clarkv1.LogoutRequest{}))
	assertCode(t, err, connect.CodeUnauthenticated)
}
...
func TestService_WhoAmI(t *testing.T) {
	...
	resp, err := svc.WhoAmI(ctxAs(user), connect.NewRequest(&clarkv1.WhoAmIRequest{}))
	if err != nil {
...
func TestService_ChangePassword_Success(t *testing.T) {
	...
	if _, err := svc.ChangePassword(ctxAs(user), connect.NewRequest(&clarkv1.ChangePasswordRequest{
	...
	if _, err := svc.Login(context.Background(), connect.NewRequest(&clarkv1.LoginRequest{
...
func TestService_ChangePassword_WrongOld(t *testing.T) {
	...
	_, err := svc.ChangePassword(ctxAs(user), connect.NewRequest(&clarkv1.ChangePasswordRequest{
...
func TestService_CreateUser_AdminCanCreate(t *testing.T) {
	...
	resp, err := svc.CreateUser(ctxAs(admin), connect.NewRequest(&clarkv1.CreateUserRequest{
		Username:    "bob",
		DisplayName: &dn,
		Password:    "bobpass",
		IsAdmin:     false,
...
func TestService_CreateUser_NonAdminDenied(t *testing.T) {
	...
	_, err := svc.CreateUser(ctxAs(regular), connect.NewRequest(&clarkv1.CreateUserRequest{
		Username: "bob", Password: "bobpass",
	}))
...
func TestService_CreateUser_MissingFields(t *testing.T) {
	...
	_, err := svc.CreateUser(ctxAs(admin), connect.NewRequest(&clarkv1.CreateUserRequest{
		Username: "", Password: "x",
	}))
	assertCode(t, err, connect.CodeInvalidArgument)
}
...
func TestService_ListUsers_AdminSeesAll(t *testing.T) {
	...
	resp, err := svc.ListUsers(ctxAs(admin), connect.NewRequest(&clarkv1.ListUsersRequest{}))
	if err != nil {
...
func TestService_ListUsers_NonAdminDenied(t *testing.T) {
	...
	_, err := svc.ListUsers(ctxAs(regular), connect.NewRequest(&clarkv1.ListUsersRequest{}))
	assertCode(t, err, connect.CodePermissionDenied)
}
...
func TestService_GetUser_Found(t *testing.T) {
	...
	resp, err := svc.GetUser(ctxAs(admin), connect.NewRequest(&clarkv1.GetUserRequest{
		Id: target.ID.String(),
	}))
	if err != nil {
...
func TestService_GetUser_NotFound(t *testing.T) {
	...
	_, err := svc.GetUser(ctxAs(admin), connect.NewRequest(&clarkv1.GetUserRequest{
		Id: missing.String(),
	}))
...
func TestService_GetUser_NonAdminDenied(t *testing.T) {
	...
	_, err := svc.GetUser(ctxAs(regular), connect.NewRequest(&clarkv1.GetUserRequest{
		Id: target.ID.String(),
	}))
	assertCode(t, err, connect.CodePermissionDenied)
}
...
func TestService_UpdateUser_SetDisplayName(t *testing.T) {
	...
	dn := "Bobby"
	resp, err := svc.UpdateUser(ctxAs(admin), connect.NewRequest(&clarkv1.UpdateUserRequest{
		Id:          target.ID.String(),
		DisplayName: &dn,
	}))
	if err != nil {
...
func TestService_UpdateUser_ClearDisplayName(t *testing.T) {
	...
	dn := "Bobby"
	if _, err := svc.UpdateUser(ctxAs(admin), connect.NewRequest(&clarkv1.UpdateUserRequest{
...
func TestService_UpdateUser_NonAdminDenied(t *testing.T) {
	...
	dn := "x"
	_, err := svc.UpdateUser(ctxAs(regular), connect.NewRequest(&clarkv1.UpdateUserRequest{
		Id: target.ID.String(), DisplayName: &dn,
	}))
	assertCode(t, err, connect.CodePermissionDenied)
}
...
func TestService_UpdateUser_InvalidID(t *testing.T) {
	...
	_, err := svc.UpdateUser(ctxAs(admin), connect.NewRequest(&clarkv1.UpdateUserRequest{
		Id: "not-a-uuid",
	}))
	assertCode(t, err, connect.CodeInvalidArgument)
}
...
func TestService_DeleteUser_Success(t *testing.T) {
	...
	if _, err := svc.DeleteUser(ctxAs(admin), connect.NewRequest(&clarkv1.DeleteUserRequest{
		Id: target.ID.String(),
	})); err != nil {
...
func TestService_DeleteUser_CannotDeleteSelf(t *testing.T) {
	...
	_, err := svc.DeleteUser(ctxAs(admin), connect.NewRequest(&clarkv1.DeleteUserRequest{
		Id: admin.ID.String(),
	}))
...
func TestService_DeleteUser_NonAdminDenied(t *testing.T) {
	...
	_, err := svc.DeleteUser(ctxAs(regular), connect.NewRequest(&clarkv1.DeleteUserRequest{
		Id: target.ID.String(),
	}))
	assertCode(t, err, connect.CodePermissionDenied)
}
...
func TestService_AdminResetPassword_Success(t *testing.T) {
	...
	if _, err := svc.AdminResetPassword(ctxAs(admin), connect.NewRequest(&clarkv1.AdminResetPasswordRequest{
...
func TestService_AdminResetPassword_NonAdminDenied(t *testing.T) {
	...
	_, err := svc.AdminResetPassword(ctxAs(regular), connect.NewRequest(&clarkv1.AdminResetPasswordRequest{
...
func TestService_AdminResetPassword_MissingNew(t *testing.T) {
	...
	_, err := svc.AdminResetPassword(ctxAs(admin), connect.NewRequest(&clarkv1.AdminResetPasswordRequest{
