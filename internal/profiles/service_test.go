...
func TestService_CreateProfile_Minimal(t *testing.T) {
	...
	resp, err := svc.CreateProfile(ctxAs(user), connect.NewRequest(&psmithv1.CreateProfileRequest{
		Name: "minimal",
	}))
	if err != nil {
...
func TestService_CreateProfile_AllFields(t *testing.T) {
	...
	if got.CompressionMode == nil || *got.CompressionMode != psmithv1.CompressionMode_COMPRESSION_MODE_APPEND {
...
func TestService_UpdateProfile_DescriptionAndParentOnly(t *testing.T) {
	...
	created, err := svc.CreateProfile(ctxAs(user), connect.NewRequest(&psmithv1.CreateProfileRequest{
		Name: "p",
	}))
	if err != nil {
		t.Fatalf("seed: %v", err)
	...
	desc := "Now described"
	parentOnly := true
	resp, err := svc.UpdateProfile(ctxAs(user), connect.NewRequest(&psmithv1.UpdateProfileRequest{
	...
	resp2, err := svc.UpdateProfile(ctxAs(user), connect.NewRequest(&psmithv1.UpdateProfileRequest{
		Id:          created.Msg.Profile.Id,
...
func TestService_CreateProfile_MissingName(t *testing.T) {
	...
	_, err := svc.CreateProfile(ctxAs(user), connect.NewRequest(&psmithv1.CreateProfileRequest{
		Name: "",
	}))
...
func TestService_CreateProfile_ParentOwnedBySomeoneElse(t *testing.T) {
	...
	parentResp, err := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{Name: "alice-parent"}))
	if err != nil {
	...
	// Bob tries to use it.
	_, err = svc.CreateProfile(ctxAs(bob), connect.NewRequest(&psmithv1.CreateProfileRequest{
		Name:            "bob-child",
		ParentProfileId: &pid,
	}))
	assertCode(t, err, connect.CodeInvalidArgument)
...
func TestService_CreateProfile_ParentNotFound(t *testing.T) {
	...
	_, err := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{
		Name:            "child",
...
func TestService_ListProfiles_PerUser(t *testing.T) {
	...
	for _, n := range []string{"a1", "a2"} {
		if _, err := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{Name: n})); err != nil {
			t.Fatalf("seed alice: %v", err)
		}
	}
	if _, err := svc.CreateProfile(ctxAs(bob), connect.NewRequest(&psmithv1.CreateProfileRequest{Name: "b1"})); err != nil {
		t.Fatalf("seed bob: %v", err)
	}

	// Alice sees her two.
	resp, err := svc.ListProfiles(ctxAs(alice), connect.NewRequest(&psmithv1.ListProfilesRequest{}))
	if err != nil {
	...
	// Bob sees his one.
	bResp, err := svc.ListProfiles(ctxAs(bob), connect.NewRequest(&psmithv1.ListProfilesRequest{}))
	if err != nil {
...
func TestService_GetProfile_Found(t *testing.T) {
	...
	created, err := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{
		Name:          "p",
	...
	resp, err := svc.GetProfile(ctxAs(alice), connect.NewRequest(&psmithv1.GetProfileRequest{
		Id: created.Msg.Profile.Id,
	}))
	if err != nil {
...
func TestService_GetProfile_OtherUserNotFound(t *testing.T) {
	...
	created, err := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{Name: "p"}))
	if err != nil {
		t.Fatalf("seed: %v", err)
	}

	_, err = svc.GetProfile(ctxAs(bob), connect.NewRequest(&psmithv1.GetProfileRequest{
		Id: created.Msg.Profile.Id,
	}))
...
func TestService_GetProfile_NotFound(t *testing.T) {
	...
	_, err := svc.GetProfile(ctxAs(alice), connect.NewRequest(&psmithv1.GetProfileRequest{
		Id: uuid.New().String(),
	}))
	assertCode(t, err, connect.CodeNotFound)
}
...
func TestService_GetProfile_Resolve_WalksParentChain(t *testing.T) {
	...
	parent, err := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{
		Name:             "parent",
	...
	child, err := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{
		Name:            "child",
		ParentProfileId: &pid,
...
func TestService_UpdateProfile_SetField(t *testing.T) {
	...
	p, err := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{Name: "p"}))
	if err != nil {
		t.Fatalf("seed: %v", err)
	}

	resp, err := svc.UpdateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.UpdateProfileRequest{
		Id:            p.Msg.Profile.Id,
...
func TestService_UpdateProfile_RenameViaName(t *testing.T) {
	...
	p, err := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{Name: "old"}))
	if err != nil {
		t.Fatalf("seed: %v", err)
	}
...
func TestService_UpdateProfile_ClearField(t *testing.T) {
	...
	p, err := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{
		Name:          "p",
...
func TestService_UpdateProfile_ReParent(t *testing.T) {
	...
	parent1Resp, _ := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{Name: "parent-A"}))
	parent2Resp, _ := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{Name: "parent-B"}))
	childResp, err := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{
		Name:            "child",
...
func TestService_UpdateProfile_ReParent_RejectsSelf(t *testing.T) {
	...
	p, _ := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{Name: "p"}))

	_, err := svc.UpdateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.UpdateProfileRequest{
		Id:              p.Msg.Profile.Id,
...
func TestService_UpdateProfile_ReParent_RejectsCycle(t *testing.T) {
	...
	grandparent, _ := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{Name: "g"}))
	parent, _ := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{
		Name:            "p",
		ParentProfileId: &grandparent.Msg.Profile.Id,
	}))
	child, _ := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{
		Name:            "c",
...
func TestService_UpdateProfile_CompressionMode(t *testing.T) {
	...
	if resp.Msg.Profile.CompressionMode == nil || *resp.Msg.Profile.CompressionMode != psmithv1.CompressionMode_COMPRESSION_MODE_REPLACE {
...
func TestService_UpdateProfile_OtherUserNotFound(t *testing.T) {
	...
	_, err = svc.UpdateProfile(ctxAs(bob), connect.NewRequest(&psmithv1.UpdateProfileRequest{
		Id:            p.Msg.Profile.Id,
...
func TestService_DeleteProfile_Success(t *testing.T) {
	...
	if _, err := svc.DeleteProfile(ctxAs(alice), connect.NewRequest(&psmithv1.DeleteProfileRequest{
		Id: p.Msg.Profile.Id,
	})); err != nil {
...
func TestService_DeleteProfile_OtherUserNotFound(t *testing.T) {
	...
	_, err = svc.DeleteProfile(ctxAs(bob), connect.NewRequest(&psmithv1.DeleteProfileRequest{
		Id: p.Msg.Profile.Id,
	}))
	assertCode(t, err, connect.CodeNotFound)
}
...
func TestService_DeleteProfile_InvalidID(t *testing.T) {
	...
	_, err := svc.DeleteProfile(ctxAs(alice), connect.NewRequest(&psmithv1.DeleteProfileRequest{
		Id: "not-a-uuid",
	}))
	assertCode(t, err, connect.CodeInvalidArgument)
}
...
func TestService_DeleteProfile_WithChildren_FailedPrecondition(t *testing.T) {
	...
	parent, err := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{Name: "parent"}))
	if err != nil {
		t.Fatalf("seed parent: %v", err)
	}
	pid := parent.Msg.Profile.Id
	if _, err := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{
		Name:            "child",
		ParentProfileId: &pid,
	})); err != nil {
		t.Fatalf("seed child: %v", err)
	...
	_, err = svc.DeleteProfile(ctxAs(alice), connect.NewRequest(&psmithv1.DeleteProfileRequest{Id: pid}))
...
func TestService_CreateProfile_WithTitleProviderKind(t *testing.T) {
	...
	resp, err := svc.CreateProfile(ctxAs(alice), connect.NewRequest(&psmithv1.CreateProfileRequest{
		Name:              "local",
