// Package mcpserver exposes a curated subset of Reeve's operations
...
// over HTTP. The intended use is dogfooding through Reeve's own `mcp`
...
// version the reeved-side mcp client speaks (plugins/mcp.go).
