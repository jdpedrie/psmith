// Package openai implements the Psmith provider driver for any backend that
...
// dependency for a single optional method isn't worth it; if Psmith needs
...
func New(deps providers.Deps, configBytes json.RawMessage) (providers.Provider, error) {
	...
	opts := []option.RequestOption{
		...
		// Psmith's stream supervisor owns retry policy. Disable SDK retries
